...
$partite = array(
   array("n"=>"1","s1"=>"Spal","s2"=>"Pisa","r1"=>"Aggiungi","rX"=>"lavora","r2"=>"1"),
   array("n"=>"2","s1"=>"Alessandria","s2"=>"Benevento","r1"=>"Aggiungi","rX"=>"lavora","r2"=>"2"),
   array("n"=>"3","s1"=>"Monza","s2"=>"Reggina","r1"=>"Aggiungi","rX"=>"lavora","r2"=>"3"),
   array("n"=>"4","s1"=>"Cosenza","s2"=>"Ascoli","r1"=>"Aggiungi","rX"=>"lavora","r2"=>"4"),
   array("n"=>"5","s1"=>"Como","s2"=>"Crotone","r1"=>"Aggiungi","rX"=>"lavora","r2"=>"5"),
   array("n"=>"6","s1"=>"Brescia","s2"=>"Ternana","r1"=>"Aggiungi","rX"=>"lavora","r2"=>"6"),
   array("n"=>"7","s1"=>"Perugia","s2"=>"Pordenone","r1"=>"Aggiungi","rX"=>"lavora","r2"=>"7")
);
...
echo "<TD colspan='3'>studenti</TD><TD style='text-align:center;'>1</TD><TD style='text-align:center;'>X</TD><TD style='text-align:center;'>2</TD>";
echo "</TR>";
for($i=0;$i<count($partite);$i++){
   echo "<TR>";
